             ...
             div(aos(
               element = 
                             div(br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),br(),
                                 ...
                                 h1(style="font-style: Arial ;font-weight: bold; color: #FEFEFE; font-size: 50px ","Global COVID 19",br(), "Clinical Trial Studies",
                                    )), 
               animation = "fade-up", 
               duration = "2000"),
             )),
    ...
    fluidRow(style = "background-color: #6467D3;",
                   ...
                   # Text Defintion
                       ...
                       column(width=6,offset=3,div(
                           aos(
                             element = p(style="font-family: Arial; color: #000000; font-size: 29px;text-align: justify; ", br(),br(),"A clinical study involves research using human volunteers that is intended to add to medical knowledge. There are two main types of clinical studies and observational studies.", br(),br(),br(),br(),), 
                             animation = "fade-up", 
                             duration = "2000")
                       ))
